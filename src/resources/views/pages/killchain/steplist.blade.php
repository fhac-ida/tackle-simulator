<?php
if (!isset($hackersteps)) {
    exit ("Hackersteps.blade: hackersteps is undefined. Please reload this page or contact the webmaster if this problem still remains.");
}
?>
...
<a href="{{ route('scenarios')}}" class="btn btn-primary">{{__('Show scenarios')}}</a>
